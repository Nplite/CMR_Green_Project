...
class CameraStream:
    def __init__(self, rtsp_url, camera_id):
        ...
        self.fps = int(30)  # Default to 30 FPS if unknown
...
class CameraProcessor:
    def __init__(self, camera_id, rtsp_url):
        ...
        self.model = YOLO('/home/alluvium/Desktop/Namdeo/CMR_Project/yolov8n.engine', verbose=True)
        self.output_params = {"-input_framerate": 30,"-vcodec": "libx264","-preset": "ultrafast","-crf": 22}
...
if __name__ == "__main__":
    camera_urls = {
        1: 'DATA/09.10.2024.mp4',
        2: 'DATA/23.10.2024 Theft project.mp4',
        3: 'DATA/18-10-2024.mp4',
        4: 'DATA/09.10.2024.mp4',
        5: 'DATA/17.10.2024.mp4',
        6: 'DATA/18-10-2024.mp4',
        7: 'DATA/09.10.2024.mp4',
        8: 'DATA/17.10.2024.mp4',
        9: 'DATA/18-10-2024.mp4',
       10: 'DATA/09.10.2024.mp4'
    }
